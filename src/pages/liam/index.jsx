  ...
  return (
    <article className="md:grid md:grid-cols-4 md:items-baseline">
      <Card className="md:col-span-3">
        <Card.Title href={`/liam/${article.slug}`}>{article.title}</Card.Title>
        <Card.Eyebrow
          as="time"
    ...
    <>
      ...
      <Container className="mt-16 sm:mt-32">
            ...
            <div className="mt-6 space-y-7 text-lg text-zinc-600 dark:text-zinc-400">
              <div className="lg:order-first lg:row-span-2">
                <div className="prose mt-6 space-y-7 text-lg text-zinc-600 dark:prose-invert dark:text-zinc-400">
                  <p>
                    Liam was born on May 14, 2021. After an ultrasound, x-ray
                    and CT scan, Liam was diagnosed with{' '}
                    <a href="https://www.mayoclinic.org/diseases-conditions/craniosynostosis/symptoms-causes/syc-20354513">
                      bicoronal craniosynostosis
                    </a>{' '}
                    at one month old. We didn’t know his craniosynostosis was
                    caused by{' '}
                    <a href="https://www.seattlechildrens.org/conditions/muenke-syndrome/">
                      Muenke Syndrome
                    </a>{' '}
                    until Liam was six months old. Muenke Syndrome is
                    characterized by craniosynostosis (the premature fusion of
                    one or more skull sutures), hearing loss and developmental
                    delays. Soon after the diagnosis, we met with our pediatric
                    plastic surgeon and neurosurgeon to discuss how they were
                    going to correct Liam’s craniosynostosis. The biggest
                    concern with any craniosynostosis diagnosis is the lack of
                    room for a child’s brain to grow. It can eventually cause
                    seizures, developmental delays and other complications
                    including death.
                  </p>
                </div>
              </div>
        ...
        <div className="mt-8">
          ...
          >
            Send Liam some cheer from his Amazon Wishlist, specifically curated
            for his unique needs.
          </Bookmark>
        </div>
      </Container>
    </>
